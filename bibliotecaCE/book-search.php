        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="book-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR LIBRO</a>
                    </li>
                </ul>
            </div>
            <!--CONTENT-->
            <div class="container-fluid">
                <section>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" placeholder="¿Qué Libro estas buscando?" style="padding: 10px; font-size: 20px;" name="caja_busqueda" id="caja_busqueda">
                    </div> 
               </section>
               <br><br><br>
               <section>
